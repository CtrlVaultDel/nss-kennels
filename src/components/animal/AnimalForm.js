      ...
      <form className="animalForm">
        ...
        <fieldset>
          <div className="form-group">
              ...
              <input type="text" id="breed" name="breed" onChange={handleControlledInputChange} required autoFocus className="form-control" placeholder="Animal breed" value={animal.breed}/>
          </div>
        </fieldset>
        <fieldset>
          <div className="form-group">
